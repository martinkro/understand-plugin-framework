package info.loveai.hook.classloader;
...
import info.loveai.hookclassloader.UPFApplication;
import info.loveai.hookclassloader.Utils;
...
public class LoadedApkClassLoaderHookHelper {
    ...
    public static void hookLoadedApkInActivityThread(File apkFile) throws ClassNotFoundException,
        ...
        String odexPath = Utils.getPluginOptDexDir(UPFApplication.getContext(), applicationInfo.packageName).getPath();

        String libDir = Utils.getPluginLibDir(UPFApplication.getContext(),applicationInfo.packageName).getPath();
