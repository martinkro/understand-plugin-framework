...
public class ActivityThreadHCallback  implements Handler.Callback{
    ...
    public ActivityThreadHCallback(Handler base) {
        mBase = base;
    }
    ...
    private void handleLaunchActivity(Message msg) {
        ...
        try {
            // 把替身恢复成真身
            // obj : ActivityClientRecord
            Log.d(TAG,"[handleLaunchActivity]start replace...");
    ...
    private static void hookPackageManager() throws Exception {
        ...
        Object proxy = Proxy.newProxyInstance(iPackageManagerInterface.getClassLoader(),
                ...
                new PackageManagerProxyHandler(sPackageManager));
